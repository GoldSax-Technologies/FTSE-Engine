<?php
$quote = file_get_contents('http://finance.google.co.uk/finance/info?client=ig&q=LON:SAND');
$avgp = "106.00"; 
$high = "106.00";
$low = "106.00";
 $json = str_replace("\n", "", $quote);
  ...
  echo "&L=".$json_output['l']."&N=SAND&"; 
$temp = file_get_contents("SANDTEMP.txt", "r");
...
$risk = (int)$risk;
          $filedash = fopen("alert.txt", "a+");
            $wrote = fputs($filedash, "SAND:".$json_output['l']. ":Breaking:PHIGH:".$high.":Buy Cost:".$risk."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
         ...
         $filedash = fopen("alert.txt", "a+");
             $wrote = fputs($filedash, "SAND:". $json_output['l']. ":Retracing:PHIGH:".$high."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
         $wrote = fputs($filedash, "SAND:". $json_output['l'].":Breaking:PLOW:".$low.":short Cost:".$risk."\r\n");
		fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
    $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "SAND:". $json_output['l'].":Retracing:PLOW:".$low."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "SAND:".$json_output['l']. ":Sliding up:PAVG:".$avgp.":Buy Cost:".$risk."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
        $wrote = fputs($filedash, "SAND:".$json_output['l']. ":Sliding down:PAVG:".$avgp.":Short Cost:".$risk."\r\n");
	fclose( $filedash );	 
     }   
}
$filedash = fopen("SANDTEMP.txt", "w");
