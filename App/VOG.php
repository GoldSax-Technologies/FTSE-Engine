<?php
$quote = file_get_contents('http://finance.google.co.uk/finance/info?client=ig&q=LON:VOG');
$avgp = "3.91"; 
$high = "4.05";
$low = "3.80";
 $json = str_replace("\n", "", $quote);
  ...
  echo "&L=".$json_output['l']."&N=VOG&"; 
$temp = file_get_contents("VOGTEMP.txt", "r");
...
$risk = (int)$risk;
          $filedash = fopen("alert.txt", "a+");
            $wrote = fputs($filedash, "VOG:".$json_output['l']. ":Breaking:PHIGH:".$high.":Buy Cost:".$risk."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
         ...
         $filedash = fopen("alert.txt", "a+");
             $wrote = fputs($filedash, "VOG:". $json_output['l']. ":Retracing:PHIGH:".$high."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
         $wrote = fputs($filedash, "VOG:". $json_output['l'].":Breaking:PLOW:".$low.":short Cost:".$risk."\r\n");
		fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
    $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "VOG:". $json_output['l'].":Retracing:PLOW:".$low."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "VOG:".$json_output['l']. ":Sliding up:PAVG:".$avgp.":Buy Cost:".$risk."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
        $wrote = fputs($filedash, "VOG:".$json_output['l']. ":Sliding down:PAVG:".$avgp.":Short Cost:".$risk."\r\n");
	fclose( $filedash );	 
     }   
}
$filedash = fopen("VOGTEMP.txt", "w");
