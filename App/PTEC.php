<?php
$quote = file_get_contents('http://finance.google.co.uk/finance/info?client=ig&q=LON:PTEC');
$avgp = "377.00"; 
$high = "393.75";
$low = "376.00";
 $json = str_replace("\n", "", $quote);
  ...
  echo "&L=".$json_output['l']."&N=PTEC&"; 
$temp = file_get_contents("PTECTEMP.txt", "r");
...
$risk = (int)$risk;
          $filedash = fopen("alert.txt", "a+");
            $wrote = fputs($filedash, "PTEC:".$json_output['l']. ":Breaking:PHIGH:".$high.":Buy Cost:".$risk."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
         ...
         $filedash = fopen("alert.txt", "a+");
             $wrote = fputs($filedash, "PTEC:". $json_output['l']. ":Retracing:PHIGH:".$high."\r\n");
		fclose( $filedash );
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
         $wrote = fputs($filedash, "PTEC:". $json_output['l'].":Breaking:PLOW:".$low.":short Cost:".$risk."\r\n");
		fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
    $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "PTEC:". $json_output['l'].":Retracing:PLOW:".$low."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
     $wrote = fputs($filedash, "PTEC:".$json_output['l']. ":Sliding up:PAVG:".$avgp.":Buy Cost:".$risk."\r\n");
	fclose( $filedash );
     }   
...
$time = date('h:i:s',$new_time);
     $filedash = fopen("alert.txt", "a+");
        $wrote = fputs($filedash, "PTEC:".$json_output['l']. ":Sliding down:PAVG:".$avgp.":Short Cost:".$risk."\r\n");
	fclose( $filedash );	 
     }   
}
$filedash = fopen("PTECTEMP.txt", "w");
